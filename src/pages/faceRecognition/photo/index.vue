...
// 单张照片逐一上传
const uploadImgUrl = 'http://192.168.100.240:8360/index/img'
// 五张一起上传，这里后台是异步执行，出错，暂不使用
const uploadImgAllUrl = 'http://192.168.100.240:8360/index/imgall'
const updateFaceUrl = 'http://192.168.100.240:8360/index/updateface'
export default {
  data () {
    return {
      video: '',
