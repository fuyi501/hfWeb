...
const updateFaceUrl = 'http://192.168.2.254:8360/img/updateface' // 更新人脸库
const searchStaffInfoUrl = 'http://192.168.2.254:8360/staff/search' // 查询员工信息
const deleteStaffInfoUrl = 'http://192.168.2.254:8360/staff/deletemanystaffinfo' // 批量删除员工信息
